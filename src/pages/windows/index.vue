<template>
  <div class="relative top-0 h-125 bg-cover bg-center bg-no-repeat bg-windows-image before:absolute before:inset-0 before:bg-black before:opacity-40 before:content-['']">
    ...
    >
      Pose de fenêtres Aluminium sur mesure
    </div>
  </div>
  <div class="style1">
    <div class="style2">
      Fenêtres et baies vitrées en alu sur mesure
    </div>
    ...
    <div class="style3">
      ...
      <br>
      <h2><strong>Des fenêtres et baies vitrées en Aluminium sur mesure</strong></h2>
      <p>
      ...
      <br>
      <h2><strong>Une personnalisation sans limite de vos fenêtres et baies vitrées en Aluminium</strong></h2>
      <p>
