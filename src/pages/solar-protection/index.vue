...
import { solarProtection as product } from '@/assets/json/products.json'
...
<template>
  <div
    class="relative top-0 h-75 bg-cover bg-center bg-no-repeat bg-solarProtection-image before:absolute before:inset-0 md:h-125 before:bg-black before:opacity-40 before:content-['']"
  >
    <div
