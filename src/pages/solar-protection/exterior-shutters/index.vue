...
<template>
  <div
    class="relative top-0 h-75 bg-cover bg-center bg-no-repeat bg-exteriorShutters-image before:absolute before:inset-0 md:h-125 before:bg-black before:opacity-40 before:content-['']"
  >
    <div
